# Devhub Homepage Mockup Spec

Create a marketing homepage for D - a developer knowledge hub for code snippets, AI prompts, commands, notes, files, images, and links.
...
A box labeled "...with Devhub" showing a simplified dashboard mockup:
